...
public class OrderCompleteTest extends Hooks {
	...
	public void endToEndTest() throws InterruptedException, IOException {
		...
		ExtentManager.pass("Have successfully click on product");

		// creating an object of the shop products page (when a product has been
		// selected)
		ShopProductPage shopProd = new ShopProductPage();
		ExtentManager.pass("Have successfully reached product page");
		Select option = new Select(shopProd.getSizeOption());
		option.selectByVisibleText("M");
		ExtentManager.pass("Have successfully selectes product size");
		...
		ExtentManager.pass("Have successfully selected the checkm out button");
		...
		ExtentManager.pass("Have successfully place order");
	}
